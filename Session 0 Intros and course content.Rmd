...
**Mina** is a Research Associate in the Fish and Fisheries Lab at James Cook University. She first became interested in using R as a tool to wrangle large datasets to assess risks posed by climate change to both animal populations and the livelihoods of human communities reliant upon them. She has worked as a teaching assistant at JCU, creating R boot camps and leading weekly workshops for students learning to model using **R**. 
