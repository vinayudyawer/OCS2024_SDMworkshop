...
This is a bit better! When predicting on a 48 hour time step with the pre-filter turned off, the models converged for all but M-156. Let's focus on the remaining five sharks. 

```{r}
fit3 <- tagdat %>%
  dplyr::filter(id %in% c("M-130", "M-150", "M-149")) %>%
